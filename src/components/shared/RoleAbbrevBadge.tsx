...
const ROLE_ABBREV: Record<string, { abbr: string; className: string }> = {
  ...
  'staff admin': { abbr: 'Ad', className: 'bg-purple-500/20 text-purple-400 border-purple-500/30' },
  ...
  'staff editor': { abbr: 'Ed', className: 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30' },
