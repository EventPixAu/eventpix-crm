  ...
  public: {
    Tables: {
      ...
      client_contact_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_contact_notes_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "client_contacts"
            referencedColumns: ["id"]
      ...
      equipment_allocations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "equipment_allocations_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
      ...
      event_equipment_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_equipment_notes_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
