...
-- Fix the convert_enquiry_to_event function to use correct workflow initialization function
...
BEGIN
  ...
  -- 11) Initialize operations workflow for the event (use correct function name)
