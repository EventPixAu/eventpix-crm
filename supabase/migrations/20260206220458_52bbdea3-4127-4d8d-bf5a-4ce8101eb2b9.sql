...
-- Fix the convert_enquiry_to_event function to use correct venues column name
...
BEGIN
  ...
  -- 2) Possibly create venue from venue_text (use address_line_1 instead of address)
