ALTER TABLE public.events
  ...
  ADD COLUMN IF NOT EXISTS parking_provided boolean,
  ADD COLUMN IF NOT EXISTS share_meal_info boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS share_parking_info boolean NOT NULL DEFAULT false;
